...
function hs_get_available_themes()
{
	return [
		...
		'parchment' => [
			'name' => 'Parchment',
			'css_class' => 'theme-parchment',
			'preview_color' => '#fbf6e9',
			'unlock_metric' => 'completed_books_count',
			'unlock_value' => 5,
			'unlock_message' => 'Complete 5 book to unlock this theme!',
		],

		'sepia' => [
			'name' => 'Sepia',
			'preview_color' => '#704214',
			'unlock_metric' => 'total_pages_read',
			'unlock_value' => 2500,
			'unlock_message' => 'Read 2,500 pages to unlock this (boring) theme!',
		],
	];
}
